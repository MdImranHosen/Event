        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
           <select class="form-control" name="admin_type_i" id="admin_type_i">
            ...
            <option value="1" data-toggle="collapse" data-target=".eventAdmin:not(.in)"> Event Admin </option>
            <option value="2" data-toggle="collapse" data-target=".eventAdmin.in"> Main Admin </option>
          </select>
        </div>
        </div>
        <div class="form-group eventAdmin collapse">
        	<label class="control-label col-sm-2" for="">Event</label>
        	<div class="col-sm-10">
            ...
            <div class="box-body">
                ...
                <tbody>
                 ...
                 <tr>
                   ...
                   <td>
                   	<?php if ($showData['type'] == 2) { ?>
                        <a class="btn btn-warning"><i class="fa fa-ban"></i> Delete </a>
                   	 <?php  } else if($showData['type'] == 1) { ?>
     ...
     <?php 
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="email" class="form-control" id="admin_email" name="admin_email" value="<?php echo $resultEdit['email']; ?>">
          </div>
        </div>
        <div class="form-group">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $('#add_admin_from').on('submit', function(){
       ...
       var typeone        = $('#admin_type_i').val();
       var admin_password = $('#admin_password_i').val();
       var admin_event    = $('#admin_event').val();
       //alert(admin_name);

       if (typeone == 1) {
       	if (admin_event == "") {
       	 $('#message_event_err').html('<div class="alert alert-danger"> Event Field Must not be Empty!</div>');
         return false;
       	}
       }
       ...
       if (admin_name == "" || admin_email == "" || typeone == "" || admin_password == "") {
        ...
        return false;
            ...
            $.ajax({
                  ...
                  data: {admin_name:admin_name,admin_email:admin_email,typeone:typeone,admin_password:admin_password,admin_event:admin_event},
